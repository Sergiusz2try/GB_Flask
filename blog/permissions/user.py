...
class UserPermissions(PermissionMixin):
    ...
    def get(self, *args, many=True, user_permissions: PermissionUser = None, **kwargs) -> PermissionForGet:
        """
        ...
        self.permission_for_get.allow_column = (self.ALL_AVAILABLE_FIELDS, 10)
        return self.permission_for_get

    def patch_permission(self, *args, user_permission: PermissionUser = None, **kwargs) -> PermissionForPatch:
        self.permission_for_patch.allow_column = (self.PATCH_AVAILABLE_FIELDS, 10)
